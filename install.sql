...
UPDATE `#__jos_modules` SET `position` = 'masthead' WHERE `jos_modules`.`position` = 'top';
UPDATE `#__jos_modules` SET `position` = 'topshelf1' WHERE `jos_modules`.`position` = 'topshelf';
UPDATE `#__jos_modules` SET `position` = 'bottomshelf1' WHERE `jos_modules`.`position` = 'bottomshelf';