<div id="footer-tab" class="ui-tabs-hide">
	...
	<div id="footer-info" class="info-panel">
		...
		<p>Although there is an option to disable / change the credits, we do ask that you consider leaving the "Morph Inside" link intact to help us promote Morph to a greater audience.</p>
	</div>
</div>