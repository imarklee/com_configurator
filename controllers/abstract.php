...
class ComConfiguratorControllerAbstract extends JController
{
	...
	function applytemplate() {
		...
		$params[] = JRequest::getVar( 'topshelf1', null, 'post', 'array' );
		$params[] = JRequest::getVar( 'topshelf2', null, 'post', 'array' );
		$params[] = JRequest::getVar( 'topshelf3', null, 'post', 'array' );
		...
		$params[] = JRequest::getVar( 'megamenu', null, 'post', 'array' );
		...
		//$params[] = JRequest::getVar( 'articlepositions', null, 'post', 'array' );
		$params[] = JRequest::getVar( 'blogenhancements', null, 'post', 'array' );
		$params[] = JRequest::getVar( 'customfonts', null, 'post', 'array' );
