...
UPDATE `#__modules` SET `position` = 'masthead' WHERE `position` = 'top';
UPDATE `#__modules` SET `position` = 'topshelf1' WHERE `position` = 'topshelf';
UPDATE `#__modules` SET `position` = 'bottomshelf1' WHERE `position` = 'bottomshelf';