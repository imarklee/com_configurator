...
<div id="outer-shelves-tab" class="ui-tabs-hide ui-tabs-panel">
	<div id="shelf-options" class="options-panel">
   	    <h3><?= @text('Top Shelf 1 Settings') ?></h3>
		<ol class="forms">
			<?= @params(array('name' => 'topshelf1')) ?>
		</ol>
		<h3><?= @text('Top Shelf 2 Settings') ?></h3>
		<ol class="forms">
			<?= @params(array('name' => 'topshelf2')) ?>
		</ol>
		<h3><?= @text('Top Shelf 3 Settings') ?></h3>
		<ol class="forms">
			<?= @params(array('name' => 'topshelf3')) ?>
		</ol>
   	    <h3><?= @text('Bottom Shelf 1 Settings') ?></h3>
		<ol class="forms">
			<?= @params(array('name' => 'bottomshelf1')) ?>
		</ol>
		<h3><?= @text('Bottom Shelf 2 Settings') ?></h3>
		<ol class="forms">
			<?= @params(array('name' => 'bottomshelf2')) ?>
		</ol>
		<h3><?= @text('Bottom Shelf 3 Settings') ?></h3>
		<ol class="forms">
			<?= @params(array('name' => 'bottomshelf3')) ?>
		</ol>
	</div>
	<div id="shelves-info" class="info-panel">
		<h3><?= @text('Top &amp; Bottom Shelves') ?></h3>
		<p class="teaser"><?= @text('The top &amp; bottom shelves are outside of the main content block. 
