...
<div id="fontsizer-tab" class="ui-tabs-hide">
	...
	<div id="fontsizer-info" class="info-panel">
		...
		<p class="teaser"><?= @text('This will enable a text resizer on your Joomla article page, allowing your readers to increase or decrease the size of the article body text.') ?></p>
		<p> </p>
	</div>
</div>