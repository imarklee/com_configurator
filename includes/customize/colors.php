...
<div id="colors-tab" class="ui-tabs-hide ui-tabs-panel">
	...
	<div id="color-info" class="info-panel">
		<h3><?= @text('Customizing your colors') ?></h3>
		<p class="teaser"><?= @text('We realize that not every themelet design is ever going to be a 100% perfect fit 
		for your business, so we have given you a couple of options to customize the colors to fit you own brand.') ?></p>
		<p><?= @text('Not sure about which colors to choose? Here is a list of our favorite (free) color palette generators:') ?></p>
