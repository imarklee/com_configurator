...
class ConfiguratorController extends JController {
	...
	function applytemplate() {
		...
		$params[11] = JRequest::getVar( 'masthead', null, 'post', 'array' );
		$params[12] = JRequest::getVar( 'subhead', null, 'post', 'array' );
		$params[13] = JRequest::getVar( 'topnav', null, 'post', 'array' );
		$params[14] = JRequest::getVar( 'topshelf', null, 'post', 'array' );
		$params[15] = JRequest::getVar( 'bottomshelf', null, 'post', 'array' );
		$params[16] = JRequest::getVar( 'user1', null, 'post', 'array' );
		$params[17] = JRequest::getVar( 'user2', null, 'post', 'array' );
		$params[18] = JRequest::getVar( 'inset1', null, 'post', 'array' );
		$params[19] = JRequest::getVar( 'inset2', null, 'post', 'array' );
		$params[20] = JRequest::getVar( 'inset3', null, 'post', 'array' );
		$params[21] = JRequest::getVar( 'inset4', null, 'post', 'array' );
		$params[22] = JRequest::getVar( 'main', null, 'post', 'array' );
		$params[23] = JRequest::getVar( 'inner-sidebar', null, 'post', 'array' );
		$params[24] = JRequest::getVar( 'splitright', null, 'post', 'array' );
		$params[25] = JRequest::getVar( 'topright', null, 'post', 'array' );
		$params[26] = JRequest::getVar( 'right', null, 'post', 'array' );
		$params[27] = JRequest::getVar( 'bottomright', null, 'post', 'array' );
		$params[28] = JRequest::getVar( 'outer-sidebar', null, 'post', 'array' );
		$params[29] = JRequest::getVar( 'splitleft', null, 'post', 'array' );
		$params[30] = JRequest::getVar( 'topleft', null, 'post', 'array' );
		$params[31] = JRequest::getVar( 'left', null, 'post', 'array' );
		$params[32] = JRequest::getVar( 'bottomleft', null, 'post', 'array' );
		$params[33] = JRequest::getVar( 'footer', null, 'post', 'array' );
