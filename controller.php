...
class ConfiguratorController extends JController {
	...
	function applytemplate() {
		...
		$params[18] = JRequest::getVar( 'bottomshelf2', null, 'post', 'array' );
		$params[19] = JRequest::getVar( 'bottomshelf3', null, 'post', 'array' );
		$params[20] = JRequest::getVar( 'user1', null, 'post', 'array' );
		$params[21] = JRequest::getVar( 'user2', null, 'post', 'array' );
		$params[22] = JRequest::getVar( 'inset1', null, 'post', 'array' );
		$params[23] = JRequest::getVar( 'inset2', null, 'post', 'array' );
		$params[24] = JRequest::getVar( 'inset3', null, 'post', 'array' );
		$params[25] = JRequest::getVar( 'inset4', null, 'post', 'array' );
		$params[26] = JRequest::getVar( 'main', null, 'post', 'array' );
		$params[27] = JRequest::getVar( 'innersidebar', null, 'post', 'array' );
		$params[28] = JRequest::getVar( 'inner1', null, 'post', 'array' );
		$params[29] = JRequest::getVar( 'inner2', null, 'post', 'array' );
		$params[30] = JRequest::getVar( 'inner3', null, 'post', 'array' );
		$params[31] = JRequest::getVar( 'inner4', null, 'post', 'array' );
		$params[32] = JRequest::getVar( 'inner5', null, 'post', 'array' );	
		$params[33] = JRequest::getVar( 'outersidebar', null, 'post', 'array' );
		$params[34] = JRequest::getVar( 'outer1', null, 'post', 'array' );
		$params[35] = JRequest::getVar( 'outer2', null, 'post', 'array' );
		$params[36] = JRequest::getVar( 'outer3', null, 'post', 'array' );
		$params[37] = JRequest::getVar( 'outer4', null, 'post', 'array' );
		$params[38] = JRequest::getVar( 'outer5', null, 'post', 'array' );
		$params[39] = JRequest::getVar( 'footer', null, 'post', 'array' );
		$params[40] = JRequest::getVar( 'components_inner', null, 'post', 'array' );
		$params[41] = JRequest::getVar( 'components_outer', null, 'post', 'array' );
		$params[42] = JRequest::getVar( 'captify', null, 'post', 'array' );
		$params[43] = JRequest::getVar( 'lazyload', null, 'post', 'array' );
		$params[44] = JRequest::getVar( 'lightbox', null, 'post', 'array' );
		$params[45] = JRequest::getVar( 'fontsizer', null, 'post', 'array' );
		$params[46] = JRequest::getVar( 'shareit', null, 'post', 'array' );
		$params[47] = JRequest::getVar( 'preloader', null, 'post', 'array' );
