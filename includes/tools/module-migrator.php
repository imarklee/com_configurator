...
<div id="module-migrator-tab">
	...
	<div id="mp-source" class="select-cont">
		...
		<div class="contents">
			...
			<p id="new-add-all"><a href="#" class="ms-add-all"><?= @text('Add all') ?></a></p>
		</div>
	</div>
	...
	<div id="mp-dest" class="select-cont">
		...
		<div class="contents">
			...
			<p id="new-remove-all"><a href="#" class="ms-remove-all"><?= @text('Remove all') ?></a></p>
		</div>
	</div>
	
	<div id="migrate-submit">
		<a href="#" class="btn-link"><?= @text('Migrate Modules') ?></a>
	</div>
	
	<div id="migrate-reset">
		<h2><?= @text('Reset Module Positions') ?></h2>
		<ul>
			<li class="migrate-outer">
			    <h3><?= @text('Reset all <strong>outer</strong> modules') ?></h3>
				<p><?= @text('This will reset all the modules in your <strong>outer</strong> positions back to the default "<strong>left</strong>" position.') ?></p>
				<p class="last"><a href="#" class="btn-link" action="outer"><?= @text('Reset to left') ?></a></p>
			</li>
			<li class="migrate-inner">
			    <h3><?= @text('Reset all <strong>inner</strong> modules') ?></h3>
				<p><?= @text('This will reset all the modules in your <strong>inner</strong> positions back to the default "<strong>right</strong>" position.') ?></p>
				<p class="last"><a href="#" class="btn-link" action="inner"><?= @text('Reset to Right') ?></a></p>
			</li>
		</ul>
	</div>
