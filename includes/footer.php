...
<div id="footer">
		...
		<ul class="footer-links">
			...
			<li class="fd">
				...
				<ul>
					<li><a href="http://twitter.com/jMorph" target="_blank"><strong>@jMorph</strong> - For Morph only updates</a></li>
					<li><a href="http://twitter.com/prothemer" target="_blank"><strong>@prothemer</strong> - Prothemer news</a></li>
					<li><a href="http://twitter.com/joomlatips" target="_blank"><strong>@joomlatips</strong> - Useful Joomla tips</a></li>
				</ul>
			</li>
		</ul>
</div>