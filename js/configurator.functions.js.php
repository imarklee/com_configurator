...
//			$(hideid+'_module_inner').parent().css('display', 'none');
		...
		$(function(){ 
			...
			blockSettingsOptions('#inner-sidebarsplitleft_chrome','#inner-sidebarsplitleft');
			blockSettingsOptions('#inner-sidebartopleft_chrome','#inner-sidebartopleft');
			blockSettingsOptions('#inner-sidebarleft_chrome','#inner-sidebarleft');
			blockSettingsOptions('#inner-sidebarbottomleft_chrome','#inner-sidebarbottomleft');
