...
shortcut will open the preferences dialog and pressing <?php echo whichKey(get_os()); ?>+p again 
will close it.</p>
...
<li><strong><?php echo whichKey(get_os()); ?> /</strong> Preview your sites module positions</li>
