...
<div id="mainhead-tab" class="ui-tabs-hide ui-tabs-panel">
	<div id="mainhead-options" class="options-panel">
   	    <h3><?= @text('Masthead Settings') ?></h3>
		<ol class="forms">
			<?= @params(array('name' => 'masthead')) ?>
		</ol>
	</div>
	<div id="mainhead-info" class="info-panel">
		<h3><?= @text('Masthead (Main Header)') ?></h3>
		<p class="teaser"><?= @text('This block is typically used for your sites branding / logo. Check the 
		<a href="#" class="logo-tab">logo tab</a> to customize your logo settings.') ?></p>
		<p><?= @text('In most cases this area will be used for your sites branding / logo, but in order to make 
		...
		class="logo-tab btn-link"><?= @text('Configure your logo settings') ?></a></p>
	</div>
</div>