...
class ConfiguratorController extends JController {
	...
	function applytemplate() {
		...
		$params[18] = JRequest::getVar( 'insets', null, 'post', 'array' );
		$params[19] = JRequest::getVar( 'main', null, 'post', 'array' );
		$params[20] = JRequest::getVar( 'inner-sidebar', null, 'post', 'array' );
		$params[21] = JRequest::getVar( 'outer-sidebar', null, 'post', 'array' );
		$params[22] = JRequest::getVar( 'footer', null, 'post', 'array' );
