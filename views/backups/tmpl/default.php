...
<div id="backup-manager">
    ...
    when restoring Database backups. All backups are saved to your <code>/morph_assets/backups/</code> folder.</p>
		<?php 
			$curr_themelet = KFactory::get('admin::com.configurator.model.configurations')->getItem()->themelet;
				...
				foreach($files as $file){
					...
					?>
						<tr class="<?php echo $splitfile[0] . ' ' . $splitfile[1]; ?>">
						    ...
						    <td class="backup-size"><?php echo KFactory::get('admin::com.configurator.helper.utilities')->formatBytes(filesize(JPATH_ROOT.'/morph_assets/backups/'.$folder.$file)); ?></td>
