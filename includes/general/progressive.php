...
<div id="progressive-tab" class="ui-tabs-hide ui-tabs-panel">
	...
	<div id="progressive-info" class="info-panel">
		<h3><?= @text('Progressive Enhancements overview') ?></h3>
		<p class="teaser"><?= @text('These are the subtle enhancements that are layered onto your site, as 
		browsers can support them. Morph has a number of these that take place automatically in 
		the background.') ?></p>
		
		<p><?= @text('Some examples of progressive enhancements that take place in Morph include the adding 
